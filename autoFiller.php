...
<head>
  ...
  <style>
    * {
    ...
    body {
      font-size: 11px;
      /* Reduced base font size for better fit */
      line-height: 1.3;
...
<body>
  ...
  <table>
    ...
    <tr style="border-bottom: 1px solid black">
      <th colspan="4" style="text-align:left;">
        <div style="display:flex; align-items:center"><span style="display:inline-block; width:50px">RFI No:</span>
          <input type="text" id="contract_no" name="contract_no" readonly />
        </div>
      </th>
    </tr>
  ...
  if (strcmp($testName, "Cube Compression Test") == 0) {
    ...
    <table>
      ...
      <tr>
        ...
        <td rowspan="3"><input type="text" class="auto-value" /></td>
      ...
      <tr>
        ...
        <td rowspan="3"><input type="text" class="auto-value-again" /></td>
        <td rowspan="3" class="selected-value" data-value="7">
          <select class="auto-calculate-again" onchange="this.parentNode.setAttribute('data-value', this.value)">
            <option selected>pick day</option>
            <option value="7">7</option>
            <option value="14">14</option>
            <option value="28">28</option>
  ...
  <script>
    ...
    const handleFetch = async (event, inputSelector, outputSelector) => {

      const selectedValue = event.target.value;
      const currentData = document.querySelector(inputSelector).value;

      try {
        console.log(
          JSON.stringify({ initialDate: currentData, selectedValue: selectedValue })
        );
        ...
        console.log(data);
        document.querySelector(outputSelector).value = data.newNepaliDate;
      } catch (error) {
        console.error(error);
      }
    ...
    document.querySelector(".auto-calculate").addEventListener("change", (event) => {
      handleFetch(event, ".nepalidatepicker", ".auto-value");
    });

    document.querySelector(".auto-calculate-again").addEventListener("change", (event) => {
      handleFetch(event, ".nepalidatepicker", ".auto-value-again");
    });
